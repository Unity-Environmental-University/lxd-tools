...
export const selectInstructorsById = createSelector(
  ...
  (instructors) => instructors.instructorsById
);
...
export const selectInstructorIdsByCourseId = createSelector(
  [selectInstructorState],
  (instructors) => instructors.instructorsByCourseId
);
export const selectInstructorsByCourseId = createSelector(
  [selectInstructorIdsByCourseId, selectInstructorsById],
  (userIdByCourseId, userById) => {
...
export const createInstructorSelector = (id: number) =>
  createSelector([selectInstructorsById], (instructorsById) => instructorsById[id]);
