...
import { mockTermData } from "@ueu/ueu-canvas";
import mockModuleData, { mockModuleItemData } from "@ueu/ueu-canvas";
...
import { mockEnrollment } from "@ueu/ueu-canvas";
...
const mockModules: IModuleData[] = [
  {
    ...
    id: 1,
    name: "Module 1",
    items: [{ ...mockModuleItemData, title: "Assignment 1", content_id: 1 }],
  },
];
...
const mockInstructors: IUserData[] = [{ ...mockUserData, id: 2, name: "Instructor Name" }];
...
describe("getRows", () => {
  ...
  const row = ([assignmentName, crit, critId, fullCrit, current, total]: string[]) =>
    [
      "Spring 2024",
      "Instructor Name",
      "TEST000",
