import { CanvasData, IModuleData, IModuleItemData } from "@ueu/ueu-canvas";
...
export const getModuleInfo = jest.fn(
  (contentItem: CanvasData, modules: IModuleData[], assignmentsCollection: AssignmentsCollection): IModuleInfo => {
    return {
      weekNumber: 1,
      moduleName: "Module",
      type: "Assigment",
...
export const getItemInModule = jest.fn(
  (contentItem: CanvasData, module: IModuleData, assignmentsCollection: AssignmentsCollection) => {
