...
import { baseCourseCode } from "@ueu/ueu-canvas";
...
export default function DateRangeExportDialog({
  ...
  return (
    <Modal show={show} onHide={handleHide} onShow={handleShow}>
            ...
            <Card>
              ...
              <Card.Body>
                <DatePicker
                  ...
                  onChange={(date) => setExportStart(date)}
                ></DatePicker>
              </Card.Body>
            </Card>
          </Col>
            ...
            <Card>
              ...
              <Card.Body>
                <DatePicker
                  ...
                  selected={exportEnd}
                  onChange={(date) => setExportEnd(date)}
                ></DatePicker>
              </Card.Body>
            </Card>
          </Col>
      ...
      <Modal.Footer>
        <Button
          onClick={async (e) => {
            ...
            let sections = await renderAsyncGen(
              getCourseDataGenerator(
                baseCourseCode(course.course_code),
