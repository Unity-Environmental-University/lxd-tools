...
import { getExternalLinks, getFileLinks } from "@ueu/ueu-canvas";
import { getContentKindFromUrl } from "@ueu/ueu-canvas";
...
export function addHomeTileButton(el: HTMLElement, course: Course) {
  ...
  rootDiv.render(<HomeTileApp el={el} course={course} />);
...
export async function addOpenAllLinksButton(header: HTMLElement, currentContentItem: BaseContentItem) {
