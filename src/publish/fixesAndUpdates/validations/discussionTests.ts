...
const run: CourseValidation<{ id: number }>["run"] = async ({ id }) => {
...
const fix: CourseFixValidation<{ id: number }, IDiscussionData>["fix"] = async (
  course,
  result?: ValidationResult<IDiscussionData>
) => {
...
export const discussionTests: CourseFixValidation<{ id: number }> = {
