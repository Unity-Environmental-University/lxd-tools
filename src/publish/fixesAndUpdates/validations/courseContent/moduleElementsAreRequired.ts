...
const _fixedPageData = (item: PageItemData & UndefinedCompletionRequirementData) => {
...
const _fixedAssignmentData = (item: AssignmentItemData & UndefinedCompletionRequirementData) => {
...
const _fix: FixTestFunction<CheckModuleCourse, CheckModuleResult, IModuleItemData[]> = async (course, result) => {
