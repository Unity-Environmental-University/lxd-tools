...
const goodHandbookLink =
  "https://unity.edu/wp-content/uploads/2025/06/Distance-Education-Student-Handbook-v.5-2-28-25.pdf";

const badHandbookRegex = /https:[^<>]*Unity-College-DE-Student-Handbook-01132023\.pdf/gi;
