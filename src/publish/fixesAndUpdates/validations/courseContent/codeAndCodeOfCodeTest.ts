...
export const codeAndCodeOfCodeTest: ContentTextReplaceFix<IContentHaver, Page> = {
  ...
  beforeAndAfters: [["<p>Honor Code and Code of Code of Conduct</p>", "<p>Honor Code and Code of Conduct</p>"]],
  description: "First bullet of course overview should read ... Unity DE Honor Code and Code of Conduct ..., not ",
  ...badContentReplaceFuncs(/Code and Code of Code of Conduct/gi, "Code and Code of Conduct"),
};
