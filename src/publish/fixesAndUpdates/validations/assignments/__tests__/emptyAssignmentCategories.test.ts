import genAssignmentGroups from "@ueu/ueu-canvas";
import deleteAssignmentGroup from "@ueu/ueu-canvas";
...
import { AssignmentGroup, IAssignmentData } from "@ueu/ueu-canvas";
...
jest.mock("@ueu/ueu-canvas/dist/content/assignments/genAssignmentGroups", () => jest.fn());
jest.mock("@ueu/ueu-canvas/dist/assignments/deleteAssignmentGroup", () => jest.fn());
