export const mockBadSyllabus = `<div class="scaffold-media-box cbt-banner cbt-image-banner cbt-home-banner" data-context-menu="insert delete">
    <div class="cbt-banner-inner flexbox v">
        ...
        <div class="cbt-banner-image" data-context-menu="rce-img"><img role="presentation" src="/courses/3949332/files/280417832/download" alt="" /></div>
    </div>
</div>
<div class="scaffold-media-box cbt-content" data-canhavechild="true" data-caninsertinto="true" data-context-menu="delete moveup movedown duplicate insertbefore insertafter insert">
    ...
    <div class="scaffold-media-box cbt-content" data-canhavechild="true" data-caninsertinto="true" data-context-menu="insert delete" data-editable="true">
        <div class="cbt-callout-box">
            <div class="content">
                <p><strong>Course Number and Title:</strong> ESCI303: Hydrology, Wetlands, and Water Policy</p>
                <p><strong>Year/Term/Session:</strong> HL-24-Jan</p>
                <p><strong>Class Inclusive</strong>&nbsp;<strong>Dates</strong>: January 15 - February 18</p>
                <p><strong>Instructor Name:&nbsp;</strong>See <a title="Home" href="/courses/3949332/pages/home" data-course-type="wikiPages" data-published="true">Homepage</a></p>
    ...
    <p><span>The course is a systematic study of the function of watersheds and wetlands, including the underlying hydrology and policies that regulate their use. Specific topics include water pathways, reservoirs, groundwater storage and utilization, general wetland ecology, and wetland policy and regulation. Students will additionally explore human impacts on hydrology and wetlands, and prepare a watershed evaluation plan.</span></p>
    <div class="scaffold-media-box cbt-content cbt-lined-heading" data-canhavechild="true" data-caninsertinto="true" data-context-menu="delete moveup movedown duplicate insertbefore insertafter insert">
        <h2>Course Outcomes</h2>
    </div>
    <p>Students will be able to:</p>
    <ol>
        <li aria-level="1"><span>Explain the roles water plays on different national and regional systems and processes.</span></li>
        <li aria-level="1"><span>Analyze and interpret data related to the hydrology of multiple systems.</span></li>
        <li aria-level="1"><span>Define and describe the specific policies underlying local, regional, and national use of water.</span></li>
        <li aria-level="1"><span>Evaluate the flow and quality of water on and below the surface in different environments.</span></li>
        <li aria-level="1"><span>Develop and present a distinct watershed evaluation plan for a real-world scenario and/or location. </span></li>
    </ol>
</div>
<div class="scaffold-media-box cbt-content" data-canhavechild="true" data-caninsertinto="true" data-context-menu="delete moveup movedown duplicate insertbefore insertafter insert">
    <h2>Grading</h2>
    <h3>Grading Policies</h3>
    <p>All assignments are due on or before the stated due dates. Work submitted 1 day late will have 10% taken off the final grade for that assignment/discussion. Work submitted 2 days late will have 30% taken off the final grade for that assignment/discussion. Work submitted 3-6 days late will have 50% taken off the final grade for that assignment/discussion. Work will not be accepted if it is more than 6 days late.</p>
        ...
        <table style="border-collapse: collapse; width: 91.9929%; height: 676px;" border="1">
            <thead>
                <tr style="height: 24px;">
                    <th style="width: 32.817%; height: 24px;" scope="col">Assignments</th>
                    <th style="width: 32.817%; height: 24px;" scope="col">Due date</th>
                    <th style="width: 32.8186%; height: 24px;" scope="col">Weight</th>
                </tr>
            </thead>
            <tbody>
                <tr>
    ...
    <div class="scaffold-media-box cbt-content" data-canhavechild="true" data-caninsertinto="true" data-context-menu="insert delete" data-editable="true">
        <div class="cbt-callout-box">
            <div class="content">
                <h3><strong>Textbook/Required Materials</strong></h3>
                <p><strong><a href="https://www.wiley.com/en-us/Principles+of+Water+Resources%3A+History%2C+Development%2C+Management%2C+and+Policy%2C+4th+Edition-p-9781119396499"><span>Water Resources: History, Development, Management, and Policy by Thomas V. Cech, 4th Edition</span></a></strong></p>
                <p>ISBN: <span>0470136316</span></p>
                <p><span>Other sites may offer the textbook with different pricing options. This <a class="inline_disabled" href="https://books.google.com/books?hl=en&amp;lr=&amp;id=A2nJCPPixGQC&amp;oi=fnd&amp;pg=PR7&amp;dq=Water+Resources:+History,+Development,+Management,+and+Policy&amp;ots=wriSggTfWZ&amp;sig=ViXRNP-4bYHk1giAg59jij39-2o#v=onepage&amp;q=Water%20Resources%3A%20History%2C%20Development%2C%20Management%2C%20and%20Policy&amp;f=false" target="_blank" rel="noopener">Google Books preview</a>, while useful, is <strong>not</strong> a suitable replacement for the textbook.</span></p>
                <p>This course does contain Labster Simulations, which are available at no cost to you as a student because Unity pays for an institutional license. Labster should authenticate you as a student and grant you immediate access to simulations when you open them. Simulations are completed in your browser. If you run into any issues, please consult the&nbsp;<strong>Labster Support &amp; Help</strong> resources below:</p>
                <ul>
                    <li style="list-style-type: none;">
                        <ul>
                            <li><a style="font-family: inherit; font-size: 1rem;" href="https://help.labster.com/en/articles/3944461-basic-labster-troubleshooting" target="_blank" rel="noopener">Basic Labster Troubleshooting</a></li>
                            <li><a style="font-family: inherit; font-size: 1rem;" href="https://help.labster.com/en/articles/1391733-contact-labster-support" target="_blank" rel="noopener">Contact Labster Support</a></li>
                            <li><a style="font-family: inherit; font-size: 1rem;" href="https://help.labster.com/en/articles/1077008-what-are-the-minimum-system-requirements-for-labster-simulations" target="_blank" rel="noopener">Minimum System Requirements for Labster</a></li>
                            <li><a style="font-family: inherit; font-size: 1rem;" href="https://help.labster.com/en/articles/3315380-stuck-in-a-simulation-quick-tips-here" target="_blank" rel="noopener">Stuck in a simulation?</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <div class="cbt-table">
            ...
            <tbody>
                ...
                <tr style="height: 310px;">
                    <td style="width: 99.8918%; height: 310px;">
                        ...
                        <p class="undergrad">Some DE Discussions will require you to post your own initial response to the prompt before viewing and responding to your peers&rsquo; posts. All Discussions will require you to post on at least two different days during the week: Your initial post by 3am ET Thursday, and your responses by 3am ET Monday. This is to ensure that you and your peers have initial posts in which to respond. If you submit your original post and your peer response on the same day, you will receive credit for only one post.&nbsp;</p>
                        <p>To access a discussion's grading rubric, click on the "Dot Dot Dot" (for screen readers, titled "Manage this Discussion") button in the upper right corner of the discussion, and then click "show rubric".</p>
                        <p><span>The <a title="Digital Citizenship Expectations" href="/courses/3266650/pages/digital-citizenship-expectations">Digital Citizenship Expectations</a> promote an engaged learning community and set the standards for online interactions in Unity Environmental University courses. Students must abide by the Digital Citizenship Expectations in all aspects of their coursework and communications.</span></p>
                    </td>
                </tr>
                ...
                <tr style="height: 952px;">
                    <td style="width: 99.8918%; height: 952px;">
                        ...
                        <h4><strong>Academic Dishonesty </strong>includes, but is not limited to&mdash;</h4>
                ...
                <tr>
                    <td style="width: 99.8918%;">
                        ...
                        <p>Using generative AI must be done with an understanding of the <a class="inline_disabled" href="/courses/3266650/pages/gen-ai-student-policy" target="_blank" rel="noopener"><strong>Unity Distance Education Generative Artificial Intelligence Policy for Students</strong></a>, which spells out acceptable and unacceptable uses of generative AI in your studies in the Unity Distance Education Program.</p>
        ...
        <div class="scaffold-media-box cbt-content" data-canhavechild="true" data-caninsertinto="true" data-context-menu="insert delete" data-editable="true">
            <div class="cbt-callout-box">
                <div class="content">
                    ...
                    <ul>
                        <li><a class="inline_disabled" href="https://www.youtube.com/watch?v=vSvlGbkpyfk" target="_blank" rel="noopener">Week 1 Lecture</a>
                            <ul class="transcripts">
                                <li><a href="/courses/3949332/files/280417917/download?wrap=1">Transcript</a></li>
                            </ul>
                        </li>
                    </ul>
                    <ul>
                        <li aria-level="2"><span>Water Resources: History, Development, Management, and Policy by Thomas V. Cech</span>
                            <ul>
                                <li aria-level="2"><span>Pages 32-48 and 72-78, Chapter 11 (wastewater treatment)</span></li>
                            </ul>
                        </li>
                        <li><a title="Labster - Principles of the Water Cycle Virtual Lab" href="/courses/3949332/assignments/45102347" data-course-type="assignments" data-published="true"><span>Principles of the Water Cycle Labster Simulation</span></a></li>
                        <li aria-level="2"><span>Academic Articles</span><strong> </strong><strong> </strong>
                            <ul>
                                <li aria-level="3"><a class="instructure_file_link inline_disabled" href="/courses/3949332/files/280417916/download" target="_blank" rel="noopener" data-api-endpoint="https://unity.instructure.com/api/v1/courses/3543843/files/236525203" data-api-returntype="File"><span>Postel, 2015</span></a></li>
                                <li aria-level="3"><a class="instructure_file_link inline_disabled" href="/courses/3949332/files/280417914/download" target="_blank" rel="noopener" data-api-endpoint="https://unity.instructure.com/api/v1/courses/3543843/files/236525202" data-api-returntype="File"><span>Viviroli, 2007</span></a></li>
                            </ul>
                        </li>
                    </ul>
                    <p>&nbsp;</p>
        ...
        <p>&nbsp;</p>
        <p><strong>Learning materials for Weeks 2 through 5 are organized with the rest of the class in your weekly modules. The modules will become available after you've viewed the <a title="Course Overview" href="/courses/3949332/pages/course-overview" data-course-type="wikiPages" data-published="true">Honor Code, Code of Conduct, and Technical Requirements</a> on the Course Overview page, which itself becomes available on the first day of the term.&nbsp;</strong></p>
    </div>
</div>`