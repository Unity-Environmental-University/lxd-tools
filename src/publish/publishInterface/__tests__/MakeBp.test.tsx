...
import * as blueprintApi from "@ueu/ueu-canvas";
import {
...
import { mockProgressData } from "@ueu/ueu-canvas";
import { mockMigrationData } from "@ueu/ueu-canvas";
import { bpify } from "@/admin";

import { createNewCourse } from "@ueu/ueu-canvas";
import * as cacheMigrationApi from "@ueu/ueu-canvas";
import { cacheCourseMigrations, loadCachedCourseMigrations } from "@ueu/ueu-canvas";
import { range } from "@ueu/ueu-canvas";
...
import { getBlueprintsFromCode } from "@ueu/ueu-canvas";

jest.mock("@canvas/course/getTermNameFromSections", () => ({
  getTermNameFromSections: jest.fn(),
}));
import { getTermNameFromSections } from "@ueu/ueu-canvas";
...
import { getSections } from "@ueu/ueu-canvas";

jest.mock("@canvas/course/retireBlueprint", () => ({ retireBlueprint: jest.fn() }));
import { retireBlueprint } from "@ueu/ueu-canvas";
