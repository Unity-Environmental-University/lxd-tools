...
export const kalturaMigrationsSlice = createSlice({
  ...
  extraReducers: (builder) =>
    builder
      ...
      .addCase(beginMigration.pending, (_state, _action) => {})
      .addCase(beginMigration.fulfilled, (_state, _action) => {}),
  reducers: {
    ...
    resetKalturaState(_state, _action: PayloadAction) {},
...
export const selectKalturaStatus = createSelector(selectKalturaState, (state) => {
  return {
    status: state.status,
    error: state.error,
    migrations: state.migrations,
