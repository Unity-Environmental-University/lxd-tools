import { getFacultyPages, getProfileFromPage } from "@ueu/ueu-canvas";
    ...
    <>
      ...
      {profiles &&
        profiles.map((profile, i) => (
          <FacultyProfile profile={profile} key={i} setProfileButton={async () => await onProfileSelect(profile)} />
        ))}
      <Form onSubmit={searchForProfiles}>
        ...
        <Button onClick={searchForProfiles} disabled={search.length < minSearchLength}>
          Submit
        </Button>
      </Form>
    </>
