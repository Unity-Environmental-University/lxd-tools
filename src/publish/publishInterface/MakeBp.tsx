import {createNewCourse, getCourseById, getCourseName} from "@ueu/ueu-canvas";
...
import {migrationsForCourseGen, IMigrationData, startMigration} from "@ueu/ueu-canvas";
...
import dateFromTermName from "@ueu/ueu-canvas";
