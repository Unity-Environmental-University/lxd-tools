...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_0__.runtime.onInstalled.addListener(() => {
...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_0__.action.onClicked.addListener((tab) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return webextension_polyfill__WEBPACK_IMPORTED_MODULE_0__.scripting.executeScript({
        target: { tabId: id },
        files: ['./js/content.js']
    });
}));
