...
import {BaseContentItem, Page} from "../../../src/canvas/content/index";
import {IGradingStandardData, IGradingStandardsHaver, IModulesHaver, IPagesHaver} from "../../../src/canvas/course"
import {
...
import {
    ...
    latePolicyTest,
    noEvaluationTest
} from "../../../src/publish/fixesAndUpdates/validations/courseSettings";
import {
    capitalize,
    matchHighlights,
    preserveCapsReplace,
