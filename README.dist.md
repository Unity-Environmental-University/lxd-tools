...
2. If you are not, follow these steps:
   ...
   - Unzip the downloaded folder and replace all filed in the folder where you first installed these tools. _Make sure the replacements have the same exact name as the original files_
...
**DEV** - Opens the DEV\_ version of the course

**BP** - Opens the BP\_ version
